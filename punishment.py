...
def main():                 # main function
    ...
    for line in range(100): # for loop, 100 loops, index 0 to 99
        a = a + 1           # increment the accumulator
        line = "I will never spam my friends again." # line to print
        print("{}. {}".format(a, line))  #string formatting with line number and string
